...
**TIP:** If you separated the code in multiple files and you have the following issues with the linter: (i) complaining about having multiple classes at the same file, or (ii) unused variables, disable the linter check for that rule in the file with a `/* eslint-disable rule-you-want-to-disable */`.
